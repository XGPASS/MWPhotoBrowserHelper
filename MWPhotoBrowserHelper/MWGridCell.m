...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        UIImage *videoIndicatorImage = [UIImage imageForBundleImageName:@"VideoOverlay"];
        ...
        //
        [_selectedButton setImage:[UIImage imageForBundleImageName:@"ImageSelectedSmallOff"] forState:UIControlStateNormal];
        [_selectedButton setImage:[UIImage imageForBundleImageName:@"ImageSelectedSmallOn"] forState:UIControlStateSelected];
...
- (void)showImageFailure {
    ...
    if (![_photo respondsToSelector:@selector(emptyImage)] || !_photo.emptyImage) {
        if (!_loadingError) {
            ...
            _loadingError.image = [UIImage imageForBundleImageName:@"ImageError"];
