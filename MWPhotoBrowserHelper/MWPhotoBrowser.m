...
- (void)performLayout {
    ...
    if (_enableGrid) {
        ...
        [items addObject:[[UIBarButtonItem alloc] initWithImage:[UIImage imageForBundleImageName:@"UIBarButtonItemGrid"] style:UIBarButtonItemStylePlain target:self action:@selector(showGridAnimated)]];
    } else {
...
- (void)storePreviousNavBarAppearance {
    ...
    _previousNavBarBGColor = self.navigationController.navigationBar.backgroundColor;
...
- (void)restorePreviousNavBarAppearance:(BOOL)animated {
    if (_didSavePreviousStateOfNavBar) {
        ...
        navBar.backgroundColor = _previousNavBarBGColor;
    ...
    for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
        if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
                ...
                [playButton setImage:[UIImage imageForBundleImageName:@"PlayButtonOverlayLarge"] forState:UIControlStateNormal];
                [playButton setImage:[UIImage imageForBundleImageName:@"PlayButtonOverlayLargeTap"] forState:UIControlStateHighlighted];
            ...
            if (self.displaySelectionButtons) {
                ...
                [selectedButton setImage:[UIImage imageForBundleImageName:@"ImageSelectedOff"] forState:UIControlStateNormal];
                ...
                if (self.customImageSelectedIconName) {
                    ...
                    selectedOnImage = [UIImage imageForBundleImageName:@"ImageSelectedOn"];
                }
