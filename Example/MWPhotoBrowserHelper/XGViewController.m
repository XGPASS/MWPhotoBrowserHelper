...
//
//  Created by XGPass on 12/08/2017.
//  Copyright (c) 2017 XGPass. All rights reserved.
//
...
@interface XGViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)registerNibWithTableView {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([SCCommonImageCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([SCCommonImageCell class])];
