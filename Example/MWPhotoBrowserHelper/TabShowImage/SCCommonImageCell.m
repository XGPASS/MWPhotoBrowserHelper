...
- (void)refreshCellWithImageDatas:(NSArray *)array title:(NSString *)title  {
    ...
    BOOL showTitle = title.length > 0 ? YES : NO;
...
- (void)registerNibWithTableView {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([SCImageCollectionCell class]) bundle:nil] forCellWithReuseIdentifier:NSStringFromClass([SCImageCollectionCell class])];
}
